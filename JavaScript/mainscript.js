	...
	var autoUpgradeCostMult = [1.7,1.3,1.25,1.3,1.35,1.3,1.25,1.2,1.15,1.1];
	...
	function autoUpgrade(x){
		...
		if(x==1){ // click upgrades
			clickAmount = Math.round(100*(clickAmount + autoUpgradeValue[x-1]))/100;
		...
		autoUpgradeCost[x-1] = Math.round(100*(autoUpgradeCost[x-1] * autoUpgradeCostMult[x-1]))/100;
		unlockMulitpliers();
	}
